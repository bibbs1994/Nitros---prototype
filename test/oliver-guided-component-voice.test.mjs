...
test('10.12.64 active blower question recognizes numbered, high-only, all, none, and partial shop language',()=>{
...
test('10.12.64 accepts terse active-question shorthand without promoting hypotheses or ambiguity',()=>{
...
test('10.12.64 contextually recovers merged speed speech while protecting decimals and pin identifiers',()=>{
...
test('10.12.64 structures commanded state separately from observed blower response',()=>{
...
test('10.12.64 commits vehicle and three contextual measurements from one utterance',()=>{
...
test('10.12.64 natural spoken decimals retain measurement context and vehicle continuity',()=>{
...
test('10.12.64 vehicle-only input remains outside mixed-intent evidence routing',()=>{
...
test('10.12.64 commits conversational observations before advancing and guards duplicates and conflicts',()=>{
