...
test('10.12.66 active blower question recognizes numbered, high-only, all, none, and partial shop language',()=>{
...
test('10.12.66 accepts terse active-question shorthand without promoting hypotheses or ambiguity',()=>{
...
test('10.12.66 contextually recovers merged speed speech while protecting decimals and pin identifiers',()=>{
...
test('10.12.66 structures commanded state separately from observed blower response',()=>{
...
test('10.12.66 commits vehicle and three contextual measurements from one utterance',()=>{
...
test('10.12.66 natural spoken decimals retain measurement context and vehicle continuity',()=>{
...
test('10.12.66 vehicle-only input remains outside mixed-intent evidence routing',()=>{
...
test('10.12.66 normalizes synonymous blower objectives into one authoritative test projection',()=>{
...
test('10.12.66 mixed result and measurement routing preserves both clauses',()=>{
...
test('10.12.66 protects vehicle identity from diagnostic-unit measurements',()=>{
...
test('10.12.66 live validation utterance preserves Jeep identity and commits both result and voltage evidence',()=>{
...
test('10.12.66 exposes deterministic active-routing diagnostics and backward-transition guard',()=>{
...
test('10.12.66 commits conversational observations before advancing and guards duplicates and conflicts',()=>{
