...
test('10.13.142 keeps the proven analyzer and production endpoint', () => {
  assert.match(analyzer, /const BUILD='10\.13\.142'/);
  assert.match(html, /10\.13\.142/);
  ...
  assert.match(serviceWorker, /const VERSION = '10\.13\.142'/);
...
test('AO wiring parser defensively normalizes legacy semantic field shapes', () => {
  ...
  assert.match(html, /version:'10\.13\.142'/);
});
