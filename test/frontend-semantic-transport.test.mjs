...
test('10.13.119 keeps the proven analyzer and production endpoint', () => {
  assert.match(analyzer, /const BUILD='10\.13\.119'/);
  assert.match(html, /10\.13\.119/);
  ...
  assert.match(serviceWorker, /const VERSION = '10\.13\.119'/);
