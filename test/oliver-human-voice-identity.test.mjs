...
test('10.12.58 preserves Oliver as the permanent professional Nitros voice identity',()=>{
...
test('professional delivery uses conservative human pacing and subtle variation',()=>{
  ...
  assert.match(source,/rate:\.94,pitch:1,volume:\.88,gain:\.88/);
