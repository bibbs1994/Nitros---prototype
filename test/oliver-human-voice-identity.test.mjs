...
test('10.12.57 preserves Oliver as the permanent professional Nitros voice identity',()=>{
...
test('dry centered overlay contract disables spatial and dynamics processing',()=>{
  for(const marker of ['centered-mono-source','identical-dual-mono-if-required','-16 LUFS provider target','-1.5 dBTP or lower provider target','stereoWidening:false','compression:false','limiting:false','roomSimulation:false','ambience:false'])assert.match(source,new RegExp(marker.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')));
});
