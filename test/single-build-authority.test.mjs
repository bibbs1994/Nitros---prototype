...
test('10.13.142 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.13\.142',[\s\S]+release:'AI Usage Live Verification & Cost Calibration',[\s\S]+buildDate:'2026-09-03'/);
...
test('service worker uses 10.13.142 version and preserves safe navigation caching',()=>{
