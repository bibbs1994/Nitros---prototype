...
test('10.13.141 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.13\.141',[\s\S]+release:'AI Usage Cost & Budget Control',[\s\S]+buildDate:'2026-09-03'/);
...
test('service worker uses 10.13.141 version and preserves safe navigation caching',()=>{
