...
test('10.13.135 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.13\.135',[\s\S]+release:'Relationship Recovery \/ Evidence Completion',[\s\S]+buildDate:'2026-09-01'/);
