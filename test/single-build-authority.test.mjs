...
test('10.13.134 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.13\.134',[\s\S]+release:'Whole-Image Defect Sweep \/ Anti-Fixation Visual Inspection',[\s\S]+buildDate:'2026-09-01'/);
...
test('service worker uses 10.13.134 version and preserves safe navigation caching',()=>{
