...
test('10.12.31 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.12\.31',[\s\S]+release:'Numeric Evidence Consistency \+ Interpretation Guard',[\s\S]+buildDate:'2026-08-12'/);
...
test('service worker uses 10.12.31 version and preserves safe navigation caching',()=>{
