...
test('10.12.93 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.12\.93',[\s\S]+release:'Verified Specification Resolution \+ Forward Isolation Routing',[\s\S]+buildDate:'2026-08-14'/);
...
test('service worker uses 10.12.93 version and preserves safe navigation caching',()=>{
