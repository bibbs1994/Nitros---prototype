...
test('10.12.94 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.12\.94',[\s\S]+release:'Verified Specification Resolution \+ Forward Isolation Routing',[\s\S]+buildDate:'2026-08-15'/);
...
test('service worker uses 10.12.94 version and preserves safe navigation caching',()=>{
