...
test('10.13.137 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.13\.137',[\s\S]+release:'Component Result Contract \/ Downstream Evidence Handoff Repair',[\s\S]+buildDate:'2026-09-02'/);
...
test('service worker uses 10.13.137 version and preserves safe navigation caching',()=>{
