...
test('10.13.119 has one canonical build authority',()=>{
  assert.match(html,/window\.NitrosBuild=Object\.freeze\(\{[\s\S]+version:'10\.13\.119',[\s\S]+release:'Visual Connection Verification \+ Confidence Calibration',[\s\S]+buildDate:'2026-08-30'/);
...
test('service worker uses 10.13.119 version and preserves safe navigation caching',()=>{
