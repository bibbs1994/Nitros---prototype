...
test('support dashboard has a dedicated server route and complete local-triage controls', () => {
  ...
  for (const text of ['Nitros Support Dashboard', 'Version 10.13.93', 'Current server status', 'Total tickets', 'In Progress', 'Fixed / Closed', 'Create TEST TICKET', 'Internal developer notes']) assert.match(dashboard, new RegExp(text));
