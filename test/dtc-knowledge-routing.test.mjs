...
test('10.12.94 resolves Chevrolet P06DD through manufacturer-enhanced registry data',()=>{
...
test('10.12.94 binds and routes P06DD to status/configuration without selecting a measurement or condemning a component',()=>{
...
test('10.12.94 rejects a stale blower route before committing the P06DD next test',()=>{
...
test('10.12.94 binds resolved DTC state before route cleanup and next-test selection',()=>{
