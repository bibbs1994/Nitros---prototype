...
test('10.12.62 applies stable natural prosody without changing ordinary spoken diagnostic words',()=>{
...
test('10.12.62 validation sample is repeatable, conversational, and below full source level',()=>{
