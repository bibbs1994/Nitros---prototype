...
test('10.12.22 exact dictated appointment parses and hydrates without saving',()=>{
...
test('10.12.22 tomorrow phrasing and automotive speech normalization preserve missing phone',()=>{
...
test('10.12.22 conversational variants resolve to equivalent structured appointments',()=>{
...
test('10.12.22 verified structured draft commits and restores after form loss',()=>{
...
test('10.12.22 hydration failure is detectable and cannot verify success',()=>{
...
test('10.12.22 exact live phone-adjacent customer and multi-field request is preserved atomically',()=>{
...
test('10.12.22 all live customer-name variants retain Derek Law independently of phone format',()=>{
...
test('10.12.22 phone-adjacent name forms remain separate entities',()=>{
...
test('10.12.22 exact live semantic appointment routes every dedicated field without losing notes',()=>{
...
test('10.12.22 automotive appointment context normalizes conservative EVAP speech variants',()=>{
...
test('10.12.22 dedicated routing variants use existing appointment option values',()=>{
