/* Nitros 10.12.22 appointment semantic normalization + dedicated field routing fix. */
(()=>{'use strict';
  const BUILD='10.12.22';
  ...
  function updateDeveloper(run,extra={}){
    ...
    const values={
      ...
      nitrosActiveClassifier:'NitrosSemanticImageAnalysis / PID temporal-claim evidence gate / 10.12.22',nitrosStaleResultLog:lastStaleMessage,
  ...
  function start(){document.title='Nitros Mobile Technician Portal v10.12.22 — Oliver Appointment Semantic Normalization + Dedicated Field Routing Fix — Build 2026-08-12';buildImportUi()}
