/* Nitros 10.12.20 voice appointment structured capture / persistence fix. */
(()=>{'use strict';
  const BUILD='10.12.20';
  ...
  function updateDeveloper(run,extra={}){
    ...
    const values={
      ...
      nitrosActiveClassifier:'NitrosSemanticImageAnalysis / PID temporal-claim evidence gate / 10.12.20',nitrosStaleResultLog:lastStaleMessage,
  ...
  function start(){document.title='Nitros Mobile Technician Portal v10.12.20 — Oliver Voice Appointment Structured Capture / Persistence Fix — Build 2026-08-12';buildImportUi()}
