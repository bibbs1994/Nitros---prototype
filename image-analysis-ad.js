/* Nitros 10.12.10 automotive graph analysis with clean-room transaction isolation. */
(()=>{'use strict';
  const BUILD='10.12.10';
  ...
  function updateDeveloper(run,extra={}){
    ...
    const values={
      ...
      nitrosActiveClassifier:'NitrosSemanticImageAnalysis / automotive graph analysis / 10.12.10',nitrosStaleResultLog:lastStaleMessage,
  ...
  function start(){document.title='Nitros Mobile Technician Portal v10.12.10 — Automotive Graph Analysis';buildImportUi()}
