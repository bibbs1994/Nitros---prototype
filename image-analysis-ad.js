/* Nitros 10.12.14 PID snapshot semantic cleanup with clean-room transaction isolation. */
(()=>{'use strict';
  const BUILD='10.12.14';
  ...
  function updateDeveloper(run,extra={}){
    ...
    const values={
      ...
      nitrosActiveClassifier:'NitrosSemanticImageAnalysis / PID snapshot semantic cleanup / 10.12.14',nitrosStaleResultLog:lastStaleMessage,
  ...
  function start(){document.title='Nitros Mobile Technician Portal v10.12.14 — PID Snapshot Semantic Cleanup — Build 2026-08-12';buildImportUi()}
