/* Nitros 10.12.21 appointment voice customer entity + multi-field routing fix. */
(()=>{'use strict';
  const BUILD='10.12.21';
  ...
  function updateDeveloper(run,extra={}){
    ...
    const values={
      ...
      nitrosActiveClassifier:'NitrosSemanticImageAnalysis / PID temporal-claim evidence gate / 10.12.21',nitrosStaleResultLog:lastStaleMessage,
  ...
  function start(){document.title='Nitros Mobile Technician Portal v10.12.21 — Oliver Appointment Voice Customer Entity + Multi-Field Routing Fix — Build 2026-08-12';buildImportUi()}
