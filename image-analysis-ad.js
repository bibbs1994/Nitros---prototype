/* Nitros 10.12.19 appointment hydration fix preserving the PID temporal-claim evidence gate. */
(()=>{'use strict';
  const BUILD='10.12.19';
  ...
  function updateDeveloper(run,extra={}){
    ...
    const values={
      ...
      nitrosActiveClassifier:'NitrosSemanticImageAnalysis / PID temporal-claim evidence gate / 10.12.19',nitrosStaleResultLog:lastStaleMessage,
  ...
  function start(){document.title='Nitros Mobile Technician Portal v10.12.19 — Oliver Appointment Form Hydration Fix — Build 2026-08-12';buildImportUi()}
