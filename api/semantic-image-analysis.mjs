...
export default async function handler(request, response) {
  ...
  try {
    ...
    const result = await analyzeSemanticImage(body, { diagnostic, enableVisualObservation: true, optimizeVisualFanout: true });
